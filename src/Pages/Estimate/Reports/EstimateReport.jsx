...
const EstimateReport = () => {
    ...
    useEffect(async () => {
        ...
        try {
            ...
            // Fetch table details
            const tablesDetailsResponse = await axios.get(`http://localhost:8080/api/estimatePreview/getEstimate/${jobID}`);
            ...
            const itemPriceTotal = await axios.get(`http://localhost:8080/api/estimatePreview/getTotalPrice/${jobID}`);
            ...
            const insurancePriceTotal = await axios.get(`http://localhost:8080/api/estimatePreview/getTotalInsurancePrice/${jobID}`);
