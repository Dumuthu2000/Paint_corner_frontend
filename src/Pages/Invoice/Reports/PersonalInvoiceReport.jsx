...
const PersonalInvoiceReport = () => {
    ...
    useEffect(async () => {
        try {
            // Fetch job details
            const jobDetailsResponse = await axios.get(`http://localhost:8080/api/job/searchJob/${jobID}`);
            ...
            // Fetch table details
            const tablesDetailsResponse = await axios.get(`http://localhost:8080/api/personalInvoice/getPersonalInvoice/${jobID}`);
            ...
            const itemPriceTotal = await axios.get(`http://localhost:8080/api/personalInvoice/getTotalItemPrice/${jobID}`);
    ...
    <>
        <div className="estimateBlocks" ref={componentRef}>
            <div className="estimateSheet">
                ...
                <h2 className='estimateTitle' style={{backgroundColor:"#284b63"}}>Invoice (P)</h2>
