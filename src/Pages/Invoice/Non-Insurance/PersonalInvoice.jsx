  ...
  const handleJobSearchBtn = async(e)=>{
    ...
    if(!jobNo){
      ...
      if(exsitsJobs){
        ...
        navigate("/invoice/personalInvoice");
      }else{
...
const paintUpdateHandler = () => {
  ...
  const handleCreatePersonalInvoice = async () => {
    try {
      ...
      if (!formData.data || formData.data.length === 0) {
        ...
        await axios.post(`http://localhost:8080/api/personalInvoice/createPersonalInvoice`, formData);
        setErrorVisible("block");
        ...
        setTimeout(() => {
          setErrorVisible("none");
          navigate('/invoice/personalInvoice-preview');
        }, 1500);
      }
    } catch (error) {
      alert(error.message);
  ...
  return (
    <div className="createEstimateContainer">
        ...
        <div className="estimateContainer">
            <Navbar className='navbarComponent' text="Personal Invoice / Create "/>
            ...
            <div className='mainContainer'>
              ...
              <button className='estimateBtn' style={{display:visible}} onClick={handleCreatePersonalInvoice}>Create Personal Invoice</button>
            </div>
        </div>
    </div>
  )
